package AdvancedCourse2.advanced_class_07;
...
public class Code_01_Scramble_String {
	...
	public static boolean func1(char[] chs1, char[] chs2, int L1, int R1,
		...
		for (int i = 0; i < (R1 - L1); i++) {
			if ((func1(chs1, chs2, L1, L1 + i, L2, L2 + i) && 
                                                     func1(chs1, chs2,L1 + i + 1, R1, L2 + i + 1, R2))
					|| (func1(chs1, chs2, L1, L1 + i, R2 - i, R2) && 
                                                                                    func1(chs1, chs2, L1 + i + 1, R1, L2, R2 - i - 1))) {
				return true;
			}
		}
		return false;
